...
export default function Home() {
  return (
    <main className="flex flex-col m-auto gap-4">
      ...
      <section id="searchbar-section" className='max-w-7xl relative bg-black/90 px-7 h-44 m-auto w-full  p-8 sm:px-16 rounded-xl shadow-md shadow-black/40 flex-col'>
        <Image src={lunch} layout="fill" objectFit="contain" alt="Breakfast Photo" className="w-full group-hover:opacity-50"/>
      </section>
