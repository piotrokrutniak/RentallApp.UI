...
export default function SearchBarCompact({setPopupOpen, onFocus, onBlur, searchString, onChange} : {setPopupOpen: any; onFocus?: any; onBlur?: any; searchString: string; onChange: (value: string) => void}){
