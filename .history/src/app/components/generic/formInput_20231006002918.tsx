export default function FormInput({className, label, type, defaultValue, placeholder, onChange, onBlur, onFocus, inputClassName, messageClassName, validationResult, validationMessage}:{
    className?: string;
    label?: string;
    type?: string;
    defaultValue?: string;
