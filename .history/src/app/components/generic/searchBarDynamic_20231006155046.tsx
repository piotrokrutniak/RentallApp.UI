...
export default function SearchBarDynamic({setPopupOpen, placeholder, label, className="", enableButton=false, onFocus, onBlur, searchString, onChange, validationResult} : {
    setPopupOpen?: any; 
    placeholder?: string;
    label?: string;
    className?: string;
