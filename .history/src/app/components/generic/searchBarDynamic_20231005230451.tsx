    ...
    return(
        <div className={`${className} flex flex-col`}>
            ...
            <div className="bg-slate-500/40 rounded-lg flex pl-5 gap-2 items-center focus-within:bg-slate-500/50 transition-colors ease-in border-2 border-transparent">
                ...
                <input type="text" value={searchString} onChange={(e) => onChange(e.target.value)} placeholder="Search for ingredients" className="bg-transparent w-full p-3 pl-0 text-white outline-none border-none"
