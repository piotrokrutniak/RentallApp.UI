        ...
        <div className="bg-black/80 sticky top-0 z-20 backdrop-blur-xl">
            <div className="w-full flex bg-slate-700/50 ">
                <div className="p-3 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <Button className="text-white w-full mt-5 mr-0 ml-auto text-xl outline outline-2 outline-white/50 bg-transparent hover:bg-green-400/90 active:opacity-80 shadow-black/40 hover:shadow-md
                        justify-center" 
                        onClick={undefined}>
                        Sign Up
                    </Button>
