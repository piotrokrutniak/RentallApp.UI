            ...
            <div className="w-full flex bg-slate-700/50 ">
                <div className="p-3 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div className="flex gap-1 opacity-90 hover:opacity-100 h-fit select-none cursor-pointer active:opacity-80 transition-all">
                        ...
                        <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r text hover:text-vermilion-500 from-vermilion-400 to-vermilion-500">RentTesla.es</h1>
                    </div>
                    </Link>
