            ...
            <div className="w-full flex bg-slate-700/50 ">
                <div className="p-3 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div className="hidden text-lg gap-4 md:flex">
                        <Button className="text-white bg-transparent active:bg-slate-100/5 hover:bg-slate-100/5 shadow-black/40 hover:shadow-sm" onClick={undefined}>
                            Locations
                        </Button>
                        <Button className="text-white bg-transparent active:bg-slate-100/5 hover:bg-slate-100/5" onClick={undefined}>
                            Bookings
                        </Button>
                        <Button className="text-white bg-vermilion-400" onClick={undefined}>
                            Sign In
                        </Button>
                        <Button className="text-white bg-transparent capitalize border-2 border-white/50 hover:border-vermilion-400 hover:text-vermilion-400 active:opacity-80" onClick={undefined}>
                            Sign Up
                        </Button>
                    </div>
