...
export default function Home() {
  return (
    <main className="flex flex-col m-auto gap-4">
      ...
      <section id="searchbar-section" className='overflow-clip max-w-7xl relative bg-red-400/50 px-7 h-64 m-auto w-full  p-8 sm:px-16 rounded-xl shadow-md shadow-black/40 flex-col'>
