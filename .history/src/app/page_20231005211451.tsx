...
export default function Home() {
  return (
    <main className="flex flex-col m-auto gap-4">
      ...
      <section id="searchbar-section" className='overflow-clip max-w-7xl relative bg-red-400/40 px-7 h-64 m-auto w-full  p-8 sm:px-16 rounded-xl shadow-md shadow-black/40 flex-col'>
        <Image src={lunch} layout="fill" objectFit="cover" alt="Breakfast Photo" className="w-full opacity-70 group-hover:opacity-50"/>
        <h1 className="absolute text-5xl z-10 text-white top-0 left-0 pb-7">Always reliable, always affordable.</h1>
      </section>
