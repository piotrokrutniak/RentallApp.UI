        ...
        <div className="w-full p-4 rounded-md bg-slate-500/40 flex gap-5">
            ...
            <div className="text-white w-full flex flex-col justify-between gap-5">
                ...
                <div className="flex justify-between place-items-center">
                    ...
                    <Button className={`${available ? "bg-green-500/80 hover:bg-green-500/90" : ""}text-white w-full md:w-fit mr-0 ml-auto text-xl  active:opacity-80 shadow-black/40 hover:shadow-md
                    justify-center`}
                    onClick={undefined}>
                    Select
                    </Button>
