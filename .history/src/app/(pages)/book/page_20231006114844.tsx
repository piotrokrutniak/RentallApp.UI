    ...
    return(
        ...
        <section id="header-section" className='max-w-7xl bg-black/90 mx-auto w-full p-6 lg:p-14 rounded-xl mt-4 shadow-md shadow-black/40'>
            <div className="flex flex-col gap-5">
                <VehicleItem title="Model S" fee={180.00}/>
            </div>
        </section>
...
function VehicleItem({title, fee}:{
    title?: string;
    fee: number;
}){
    ...
    return(
        <div className="w-full p-4 rounded-md bg-slate-500/40 flex gap-5">
            <div className="h-40 aspect-square bg-white rounded-md relative flex shrink-0">
            ...
            <div className="text-white w-full flex flex-col justify-between gap-5">
                <h1 className="text-3xl font-bold">Tesla {title}</h1>
                <h2 className="text-xl"> Available at ${fee}/day.</h2>
                <div className="flex justify-between place-items-center">
                    ...
                    <Button disabled={available} className={`${available ? "bg-green-500/80 hover:bg-green-500/90" : "bg-slate-500 cursor-not-allowed"} text-white w-full md:w-fit mr-0 ml-auto text-xl  active:opacity-80 shadow-black/40 hover:shadow-md
                    justify-center`}
                    onClick={undefined}>
                    Select
                    </Button>
