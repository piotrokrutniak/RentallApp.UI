...
export default function BookingPage(){
    ...
    return(
        ...
        <section id="header-section" className='max-w-7xl bg-black/90 mx-auto w-full p-14 rounded-xl mt-4 shadow-md shadow-black/40'>
            ...
            <h1 className="text-5xl md:text-6xl"> Book your tesla now. </h1>
        ...
        <section id="header-section" className='max-w-7xl bg-black/90 mx-auto w-full p-4 lg:p-14 rounded-xl mt-4 shadow-md shadow-black/40'>
