...
export default function BookingPage(){
    ...
    function UpdateVehicles(){
        setValidation({location: booking.locationId > 0, startDate: booking.startDate != "", endDate: booking.endDate != ""})
        
        if(validation.endDate && validation.startDate && validation.location){
