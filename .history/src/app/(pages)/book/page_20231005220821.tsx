...
export default function BookingPage(){
    return(
        ...
        <section id="header-section" className='max-w-7xl bg-black/90 mx-auto w-full p-14 rounded-xl mt-4 shadow-md shadow-black/40'>
            ...
            <div className="flex flex-col gap-10 shrink-0 justify-between md:pb-10 text-white">
            ...
            <div className="relative w-full h-96 left-0 flex gap-10 pt-3 overflow-x-auto m-auto justify-around select-none md:pb-10 text-white">
