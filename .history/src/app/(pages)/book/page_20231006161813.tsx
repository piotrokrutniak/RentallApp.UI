...
export default function BookingPage(){
    ...
    function ValidateUserDetails(){
        setValidation({...validation, email: booking.email != "", phone: booking.phone != ""})
    }
            ...
            <div className="text-white w-full flex flex-col justify-between gap-1">
                ...
                <div className="flex justify-between place-items-center">
                    ...
                    className={`${booking.vehicleId == vehicle.id && available ? "bg-green-500/80 hover:bg-green-500/90" : ""} 
                        text-white w-fit mr-0 ml-auto text-xl  active:opacity-80 shadow-black/40 hover:shadow-md justify-center`}>
