...
export default function BookingPage(){
    ...
    return(
        ...
        {vehicles.length > 0 && 
        <section id="header-section" className='max-w-7xl bg-black/90 mx-auto w-full p-6 lg:p-14 rounded-xl mt-4 shadow-md shadow-black/40 text-white'>
            <h1 className="hidden md:block text-3xl sm:text-5xl md:text-6xl mb-4"> Choose a vehicle. </h1>
            <div className="flex flex-col gap-5">
                 ...
                 <div className="text-3xl mt-5 flex flex-row-reverse">Total: ${fee.toFixed(2)}</div>
            </div>
        </section>}
