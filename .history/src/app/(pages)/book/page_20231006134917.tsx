...
export default function BookingPage(){
    ...
    function UpdateVehicles(){
        GetVehicles(searchValue).then(x => {setVehicles([...x.data])})
        ...
        <div className="w-full p-4 rounded-md bg-slate-500/40 flex gap-5">
            ...
            <div className="text-white w-full flex flex-col justify-between gap-1">
                ...
                <div className="flex justify-between place-items-center">
                    ...
                    className={`${booking.vehicleId == vehicle.id && available ? "bg-green-500/80 hover:bg-green-500/90" : "bg-blue-500/80 hover:bg-blue-500/90"} text-white w-full md:w-fit mr-0 ml-auto text-xl  active:opacity-80 shadow-black/40 hover:shadow-md
                    justify-center`}>
