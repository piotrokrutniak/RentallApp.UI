...
function VehicleItem({title, fee}:{
    ...
    return(
        <div className="w-full p-4 h-44 rounded-md bg-slate-500/40 flex gap-5">
            <div className="h-full aspect-square bg-white rounded-md relative flex shrink-0">
            ...
            <div className="text-white flex flex-col gap-5">
                <h1 className="text-3xl">Tesla {title}</h1>
