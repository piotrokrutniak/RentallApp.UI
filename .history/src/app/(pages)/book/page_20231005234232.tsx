    ...
    return(
        ...
        <section id="header-section" className='max-w-7xl bg-black/90 mx-auto w-full p-6 lg:p-14 rounded-xl mt-4 shadow-md shadow-black/40'>
            ...
            <div className="flex flex-col  gap-10 w-full justify-between md:pb-10 text-white">
                ...
                <Button className="w-fit py-4 max-md:ml-auto max-md:mr-0 rounded-lg shadow-md shadow-black hover:bg-vermilion-500 bg-transparent capitalize border-white/50 hover:border-vermilion-500 border-2 text-xl md:text-2xl"> 
                Search
                </Button>
            </div>
