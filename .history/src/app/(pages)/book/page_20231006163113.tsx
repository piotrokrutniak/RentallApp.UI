...
export default function BookingPage(){
    ...
    function ValidateUserDetails(){
        setValidation({...validation, email: booking.email != "", confirmedEmail: booking.email == confirmedEmail, phone: booking.phone != ""})
    }
    ...
    return(
        ...
        <section id="header-section" className='max-w-7xl bg-black/90 mx-auto w-full p-6 lg:p-14 rounded-xl mt-4 shadow-md shadow-black/40'>
            <div className="relative lg:w-1/2 left-0 flex flex-col gap-5 pt-3 overflow-x-auto m-auto justify-around select-none md:pb-10 text-white">
                <FormInput className="w-full" label="Email" onChange={UpdateEmail} validationResult={validation.email} validationMessage="This field is required."/>
                <FormInput className="w-full" label="Confirm Email" onChange={setConfirmedEmail} validationResult={validation.confirmedEmail} validationMessage="Emails are nopt matching."/>
                <FormInput className="w-full" label="Phone Number" onChange={UpdatePhone} validationResult={validation.phone} validationMessage="This field is required."/>
            ...
            <div className="text-white w-full flex flex-col justify-between gap-1">
                ...
                <div className="flex justify-between place-items-center">
                    ...
                    className={`${booking.vehicleId == vehicle.id && available ? "bg-green-500/80 hover:bg-green-500/90" : ""} 
                        text-white w-fit mr-0 ml-auto text-sm  active:opacity-80 shadow-black/40 hover:shadow-md justify-center`}>
