  ...
  return (
    <main className="flex flex-col m-auto gap-4">
      <section id="header-section" className='max-w-7xl bg-black/90 m-auto w-full p-8 rounded-xl mt-4 shadow-md shadow-black/40'>
        ...
        <div className="relative w-fit h-96 left-0 flex gap-10 pt-3 overflow-x-auto m-auto justify-around select-none pb-10">
            <Image src={tesla} layout="fill" objectFit="contain" alt="Breakfast Photo" className="opacity-60 h-96 group-hover:opacity-50"/>
        </div>
        </div>
      </section>
