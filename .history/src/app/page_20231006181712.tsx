...
export default function Home() {
  return (
    <main className="flex flex-col gap-4">
      <section id="header-section" className='max-w-7xl bg-black/90 m-auto w-full max-md:pb-4 p-14 rounded-xl mt-4 shadow-md shadow-black/40'>
        <div className='w-full flex flex-col md:flex-row justify-between'>
          ...
          <div className="relative w-full h-96 left-0 flex gap-10 pt-3 overflow-x-auto m-auto justify-around select-none md:pb-10">
              <Image src={tesla} layout="fill" objectFit="contain" alt="Tesla Photo" className="h-96"/>
          </div>
        </div>
      </section>
      ...
      <section id="searchbar-section" className='overflow-clip max-w-7xl relative bg-red-500/30 px-7 h-80 m-auto w-full p-8 sm:px-16 rounded-xl shadow-md shadow-black/40 flex-col'>
        <Image src={mallorca} layout="fill" objectFit="cover" alt="Mallorca View Photo" className="w-full opacity-60 group-hover:opacity-50"/>
