    ...
    <main className="flex flex-col m-auto gap-4">
      <section id="header-section" className='max-w-7xl bg-black/90 m-auto w-full px-14 py-8 rounded-xl mt-4 shadow-md shadow-black/40'>
        ...
        <div className='w-full flex justify-between'>
          ...
          <Button className="w-fit rounded-lg shadow-md shadow-black hover:bg-blue-500 bg-transparent capitalize border-white/50 hover:border-blue-500 border-2 text-2xl"> Book Now </Button>
          </div>
