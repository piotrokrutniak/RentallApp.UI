  ...
  return (
    <main className="flex flex-col m-auto gap-4">
      ...
      <section id="searchbar-section" className='overflow-clip max-w-7xl relative bg-red-400/50 px-7 h-80 m-auto w-full p-8 sm:px-16 rounded-xl shadow-md shadow-black/40 flex-col'>
        ...
        <h1 className="text-4xl z-10 text-white top-0 left-0 p-6">Always reliable, always affordable.</h1>
        <h1 className="text-4xl z-10 text-white top-0 left-0 p-6"><span className="text-vermilion-400">RentTesla.es</span></h1>
        </header>
      </section>
    </main>
  )
