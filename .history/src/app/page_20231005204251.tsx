...
export default function Home() {
  return (
    <main className="flex flex-col m-auto gap-4">
      <section id="header-section" className='max-w-7xl bg-black/90 m-auto w-full p-10 rounded-xl mt-4 shadow-md shadow-black/40'>
        <div className="sm:p-8 pb-14 flex justify-between">
          
        </div>
        <div className='w-full flex justify-between'>
          <h1 className="text-5xl md:text-6xl text-white"> Rent a <span className="text-vermilion-400">Tesla</span> on Mallorca. </h1>
