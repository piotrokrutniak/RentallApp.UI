...
export default function VehicleItem({vehicle, startDate, endDate, select, booking}:{
    vehicle: Vehicle,
    startDate: string,
    endDate: string;
    ...
    return(
        <div className="w-full p-4 rounded-md bg-slate-500/40 flex gap-5">
            ...
            <div className="text-white w-full flex flex-col justify-between gap-1">
                <h1 className="text-xl sm:text-2xl sm:mt-2 font-semibold">{vehicle.make + " " + vehicle.model}</h1>
                ...
                <div className="flex justify-between place-items-center">
                    ...
                    <span className="text-vermilion-400">Unavailable</span>
                    }
                    </h3>
                    <Button disabled={!available} onClick={() => select(vehicle)} 
